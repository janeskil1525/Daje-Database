package Daje::Database::Postgres;
use Mojo::Base -base, -signatures, -async_await;

use Daje::Database::Helper::Instring;
...
=head2 build_create($self,

 build_create($self,();

=head2 build_delete($self,

 build_delete($self,();

=head2 build_list($self,

 build_list($self,();

=head2 build_load($self,

 build_load($self,();

=head2 build_methods($self,

 build_methods($self,();

=head2 build_update($self,
...
=head2 get_specials_data($self,

 get_specials_data($self,();

=head2 get_table_column_names($self,
