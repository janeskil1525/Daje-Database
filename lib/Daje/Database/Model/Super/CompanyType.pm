...
Daje::Database::Model::Super::CompanyType
...
=head2 insert_company_type($data)

 insert_company_type($data)();

=head2 load_list($key_value)

 load_list($key_value)();

=head2 load_pkey($company_type_pkey)

 load_pkey($company_type_pkey)();

=head2 update_company_type($data,

 update_company_type($data,();
